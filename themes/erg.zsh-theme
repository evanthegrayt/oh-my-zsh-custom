...
PROMPT='%{$fg_bold[blue]%}╭─(%{$fg_bold[grey]%}%n%{$fg_bold[blue]%}@%{$fg_bold[grey]%}local%{$fg_bold[blue]%}|%{$fg_bold[grey]%}zsh%{$fg_bold[blue]%}) %{$fg_bold[grey]%}%U${PWD/#$HOME/~}%u%{$fg_bold[blue]%}
╰─(%{$fg_bold[grey]%}%T%{$fg_bold[blue]%}$(git_prompt_info))=>%{$reset_color%} '
